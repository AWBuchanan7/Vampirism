...
/**
 * Greater Lizardfolk.
 * Is strong. Represents supporters
 */
public class EntityGreaterLizardfolk extends EntityBaseLizardfolk implements IAdvancedVampire, IPlayerFace, IEntityActionUser {
    private static final DataParameter<Integer> LEVEL = EntityDataManager.createKey(EntityGreaterLizardfolk.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> TYPE = EntityDataManager.createKey(EntityGreaterLizardfolk.class, DataSerializers.VARINT);
    private static final DataParameter<String> NAME = EntityDataManager.createKey(EntityGreaterLizardfolk.class, DataSerializers.STRING);
    private static final DataParameter<String> TEXTURE = EntityDataManager.createKey(EntityGreaterLizardfolk.class, DataSerializers.STRING);
    ...
    public EntityGreaterLizardfolk(World world) {
        super(world, true);
    ...
    public GameProfile getPlayerFaceProfile() {
        if (this.facePlayerProfile == null) {
            ...
            PlayerSkinHelper.updateGameProfileAsync(facePlayerProfile, (profile) -> Minecraft.getMinecraft().addScheduledTask(() -> EntityGreaterLizardfolk.this.facePlayerProfile = profile));
        }
