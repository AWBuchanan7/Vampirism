...
public class Util {
    ...
    public static String readResource(String path) {
        ...
        try {
            data = IOUtils.toString(new InputStreamReader(VampirismMod.class.getClassLoader().getResourceAsStream(location)));
        } catch (IOException e) {
    ...
    public static String httpGet(String url) {
        try {
        	...
        	VampirismMod.getLog().error("Failed to GET from: " + url);
        }
        return "";
    }
}
